    ...
    <div className="flex justify-center items-center my-6 space-x-2">
      {currentPage > 1 && (
        <button
          ...
          className="px-4 py-2 bg-gray-200 dark:bg-slate-300 text-gray-700 rounded-md shadow-md hover:bg-gray-300"
        >
          &lt;
        </button>
      )}

      <span className="px-4 py-2 bg-blue-200 dark:bg-slate-500 text-gray-900 dark:text-white rounded-md shadow-md">
        Page {currentPage}
      </span>
